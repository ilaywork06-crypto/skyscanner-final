      ...
      <v-card-text class="add-entity__body">
        ...
        >
          ...
          <v-text-field
            ...
            v-model="reason"
            placeholder="Enter an explanation about the edit..."
          />
        </div>
      </v-card-text>
...
const NAME_MISSING = 'Type and a name are required'
const NOTHING_CHANGED = 'Nothing has changed yet'
const REASON_MISSING = 'A reason must be provided before this can be saved'
