      ...
      <div class="entity-form__field">
        ...
        >
          ...
          <UiInfoIcon label="What Name means">
            A short name that explains about the entity.
          </UiInfoIcon>
        </label>
        <v-text-field
          :id="`${idPrefix}-name`"
      ...
      <div class="entity-form__field">
        ...
        >
          ...
          <UiInfoIcon label="What Module means">
            Origin of telemetry - the part of the platform that produced the data.
          </UiInfoIcon>
        </label>
        <v-select
      ...
      <div class="entity-form__field">
        ...
        >
          ...
          <UiInfoIcon label="What Code version means">
            Version of the code used (e.g., 1.1, 2.3)
          </UiInfoIcon>
        </label>
        <v-text-field
          :id="`${idPrefix}-version`"
...
const statusHint = computed<string>(() =>
  isParsed.value
    ? 'Parsed fie is given so status is set to parsed.'
    : 'You must upload the parsed file to set the status to parsed.',
)

const statusExplanation = computed<string>(() =>
  'Indicate the parsing status of the files.'
)
